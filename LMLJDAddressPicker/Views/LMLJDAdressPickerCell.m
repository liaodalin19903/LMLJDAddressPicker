...
@implementation LMLJDAdressPickerCell
...
- (void)initUI {
    ...
    UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0, self.contentView.bounds.size.height - 1, self.bounds.size.width, 1)];
